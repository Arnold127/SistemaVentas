                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="col-sm-6 d-flex">
                                    ...
                                    <input type="submit" name="accion" value="BuscarCliente" class="btn btn-outliine-info">
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" name="nombrecliente" value="${c.getNom()}" placeholder="Datos Cliente" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group d-flex">
                                <div class="col-sm-6 d-flex">
                                    ...
                                    <button type="submit" name="accion" value="BuscarProducto" class="btn btn-outliine-info"></button>
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" name="nombreproducto" value="${producto.getNom()}" placeholder="Datos Cliente" class="form-control">
                                </div>
                            </div>
                            <div class="form-group d-flex">
                                <div class="col-sm-6 d-flex">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <div class="col-sm">
                                        <button type="submit" name="accion" value="Agregar" class="btn btn-outliine-primary"></button>
                                    </div>
                                </div>  
                            </div>
                    </form>
